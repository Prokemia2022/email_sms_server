	...
	if (!payload){
		...
		const verify_email_template = `
			<body style='font-family: Poppins; padding: 10px;'>
			  <h2 style="color:#009898;font-size: 36px;text-align: center;">The link invoice order of ${payload.order_id} has been attached .</h2>
		...
		`
		  ...
		  await Transporter.sendMail({
		    ...
		    text: 'the invoice for your order has been sent', // plain text body
